...
assert.match(output, /YURUTTOWEB_TEXT_CONFIG=\{"avoidCanvasThemeFont":false\}/);
assert.equal((output.match(/id="yuruttoweb-text-config"/g) || []).length, 1, '設定scriptが重複');
