...
DOM化対象は文字glyphのみ。Label、Button、LinkButtonの背景、枠、icon、入力判定、物理、ShaderはCanvas所有。ButtonのiconはCanvasへ残したまま文字矩形だけを同期。autowrap、文字省略、独自fontなど正確に再現できない設定はCanvasへ戻す。
...
- 境界: 親clip、Material、独自font、文字省略、削除
