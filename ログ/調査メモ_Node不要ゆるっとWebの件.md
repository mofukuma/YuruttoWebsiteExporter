...
- site生成：`EditorExportPreset`の値、`ProjectSettings`、`gdweb-site.json`からGDScriptで生成。
...
利用者に必要なものはGodot 4.7.1と`addons/gdweb_site`だけ。Node.js、公式Export template、repository内build scriptを利用時の前提にしない構成。
